...
import { NavItem, StatItem, AdvantageItem, ServiceItem, CaseItem, FAQItem, TeamMember, PricingItem, ReviewItem, ClientItem, AwardItem, BlogPost, CaseStudyData, InfographicItem, InfographicProcessStep, InfographicPriceItem, TickerItem, TargetAudienceItem } from './types';

export const LOGO_URL = 'https://i.1.creatium.io/disk2/1b/5c/03/da3bf5f56bec0d87b9985b2cad44160d58/118x63/logo_main_1.svg';
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { 
    ...
    children: [
      ...
      { label: 'Вывод в ТОП', href: '/seo/top' },
      { label: 'Снятие санкций', href: '/seo/sanctions' },
    ]
  },
  {
    label: 'Аудит',
    href: '/audit',
    children: [
        { label: 'SEO-аудит (Технический)', href: '/audit/seo' },
  ...
  },
  {
    ...
    href: '/dev',
    children: [
        { label: 'Корпоративные сайты', href: '/dev/corporate' },
        { label: 'Интернет-магазины', href: '/dev/shop' },
        { label: 'Landing Page', href: '/dev/landing' },
        { label: 'Техническая поддержка', href: '/dev/support' },
        { label: 'SERM (Репутация)', href: '/serm' },
    ]
  },
  {
    label: 'Реклама',
    href: '/ads',
    children: [
        { label: 'Контекстная реклама', href: '/ads/context' },
        { label: 'Таргетированная реклама', href: '/ads/target' },
        { label: 'Реклама в Telegram', href: '/ads/telegram' },
        { label: 'Продвижение на Авито', href: '/ads/avito' },
        { label: 'Маркетплейсы', href: '/marketplace-seo' },
    ]
  },
  {
    label: 'GEO / AI',
    href: '/geo-ai',
    children: [
        { label: 'Продвижение в ChatGPT', href: '/geo/chatgpt' },
        { label: 'Оптимизация под Gemini', href: '/geo/gemini' },
        { label: 'Вывод в Perplexity', href: '/geo/perplexity' },
        { label: 'Bing Chat (Copilot)', href: '/geo/copilot' },
        { label: 'Управление выдачей AI', href: '/geo/reputation' },
    ]
  },
  { label: 'Кейсы', href: '/cases', isPage: true },
...
export const SERVICES_INCLUDED = [
  { title: 'АНАЛИЗ КОНКУРЕНТОВ', desc: 'Проводим анализ конкурентов больше, чем по 15 метрикам. Полученные данные мы используем в стратегии продвижения в поисковых системах.', image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80&w=800' },
  { title: 'СЕМАНТИЧЕСКОЕ ЯДРО', desc: 'Собираем максимально полное семантическое ядро (без ограничения по количеству запросов), чистим его и кластеризуем согласно данным из ТОП-10.', image: 'https://images.unsplash.com/photo-1543286386-2e659306cd6c?auto=format&fit=crop&q=80&w=800' },
  { title: 'ТЕХНИЧЕСКИЙ АУДИТ', desc: 'Проводим всесторонний аудит вашего сайта по собственному чек-листу из 21 направления технической оптимизации и проверяем результаты.', image: 'https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&q=80&w=800' },
  { title: 'ВНЕШНЯЯ ОПТИМИЗАЦИЯ', desc: 'Анализируем ссылочную стратегию лидеров и дорабатываем её под продвигаемый проект, затем реализуем посредством закупки ссылок.', image: 'https://images.unsplash.com/photo-1557804506-669a67965ba0?auto=format&fit=crop&q=80&w=800' },
  { title: 'РАБОТА С КОНТЕНТОМ', desc: 'Проводим текстовый анализ сайтов из ТОП Яндекс и Google по ключевым запросам, пишем ТЗ для копирайтера и внедряем контент.', image: 'https://images.unsplash.com/photo-1586281380349-632531db7ed4?auto=format&fit=crop&q=80&w=800' },
  { title: 'АНАЛИЗ ЮЗАБИЛИТИ', desc: 'Повышаем конверсию и юзабилити, оптимизируем текстовое наполнение и код сайта. Учитываем особенности каждой сферы.', image: 'https://images.unsplash.com/photo-1586717791821-3f44a5638d0f?auto=format&fit=crop&q=80&w=800' },
  { title: 'РАБОТА С ПФ', desc: 'Для улучшения поведенческих факторов мы привлекаем маркетолога и аналитика, которые улучшают Last-клик на сайте.', image: 'https://images.unsplash.com/photo-1533750516457-a7f992034fec?auto=format&fit=crop&q=80&w=800' },
  { title: 'АНАЛИТИКА', desc: 'По окончанию месяца мы делаем отчет. Регулярная аналитика помогает вам понимать результаты нашей деятельности, а нам делать проверку гипотез.', image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80&w=800' },
];
...
export const VIDEO_REVIEWS = [
  { title: "Продвинули сайт в нише Fin-Tech на рынке Европы", author: "Глеб", role: "Руководитель проекта Fin-Tech", image: 'https://images.unsplash.com/photo-1557804506-669a67965ba0?auto=format&fit=crop&q=80&w=800' },
  { title: "Клиенты стали приходить уже в первые недели", author: "Алексей", role: "Владелец интернет-магазина", image: 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&q=80&w=800' },
  { title: "Рост продаж в 3 раза за полгода работы", author: "Мария", role: "Директор по маркетингу", image: 'https://images.unsplash.com/photo-1573496359-794d6a6c305d?auto=format&fit=crop&q=80&w=800' },
  { title: "Вышли в ТОП-3 по Москве за 4 месяца", author: "Сергей", role: "Основатель клиники", image: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&q=80&w=800' },
  { title: "Комплексный подход: SEO + SERM", author: "Елена", role: "Бренд-менеджер", image: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&q=80&w=800' }
];

export const LETTERHEAD_REVIEWS = [
  { company: 'Scrile', image: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?auto=format&fit=crop&q=80&w=600', alt: 'Благодарственное письмо от Scrile' },
  { company: 'Champion', image: 'https://images.unsplash.com/photo-1554224154-260327c0d14d?auto=format&fit=crop&q=80&w=600', alt: 'Отзыв компании Champion' },
  { company: 'BestMaterials', image: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?auto=format&fit=crop&q=80&w=600', alt: 'Рекомендация BestMaterials' },
];
...
export const PRICING_PLANS: PricingItem[] = [
  { 
    title: 'ПОДДЕРЖКА', 
    price: 'от 47 000 руб', 
...
export const TEAM_MEMBERS: TeamMember[] = [
  { name: 'Иван Смирнов', role: 'Руководитель агентства', image: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&q=80&w=400', bio: ['Более 8 лет опыт в SEO', 'Преподаватель SkillBox', 'Автор системы "Колесо Баланса"'] },
...
export const MAIN_AWARDS: AwardItem[] = [
  { place: 35, title: '35 место в рейтинге SEO агентств Москвы', color: 'from-red-500 to-red-700', description: 'Рейтинг Рунета', media: 'Рейтинг Рунета' },
  { place: 6, title: '6 место в рейтинге SEO услуг для строительных компаний', color: 'from-red-500 to-red-700', description: 'Рейтинг Рунета', media: 'Рейтинг Рунета' },
  { place: 15, title: '15 место в рейтинге SEO услуг для сферы IT', color: 'from-red-500 to-red-700', description: 'Рейтинг Рунета', media: 'Рейтинг Рунета' },
  { place: 100, title: 'Топ-100 SEO агентств в РФ', color: 'from-red-500 to-red-700', description: 'Рейтинг Рунета', media: 'Рейтинг Рунета' },
  { place: 78, title: '78 место в рейтинге среди SEO-агентств Москвы', color: 'from-red-500 to-red-700', description: 'Рейтинг Рунета', media: 'Рейтинг Рунета' },
  { place: 9, title: '9 место в рейтинге по продвижению сайтов на Laravel', color: 'from-red-500 to-red-700', description: 'Рейтинг Рунета', media: 'Рейтинг Рунета' },
  { place: 66, title: '66 место в рейтинге по продвижению сайтов на WordPress', color: 'from-red-500 to-red-700', description: 'Рейтинг Рунета', media: 'Рейтинг Рунета' },
];
...
export const FAQS: FAQItem[] = FAQ_ITEMS.map(item => ({
  question: item.q,
  answer: item.a
}));

export const CLIENTS: ClientItem[] = CLIENT_LOGOS.map(logo => ({ logoText: logo }));
...
export const INFOGRAPHICS_PORTFOLIO: InfographicItem[] = [
...
export const INFOGRAPHIC_PROCESS: InfographicProcessStep[] = [
...
export const INFOGRAPHIC_PRICING: InfographicPriceItem[] = [
...
export const AI_SERVICES_PRICING: InfographicPriceItem[] = [
...
export const HERO_TICKER: TickerItem[] = [
