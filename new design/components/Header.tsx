...
import { Menu, X, ChevronDown, Phone, Send, MessageCircle, Mail } from 'lucide-react';
...
const Header: React.FC<HeaderProps> = () => {
  ...
  const headerBgClass = (isHome && !isScrolled && !hoveredNav) 
    ? 'bg-transparent py-6' 
    : 'bg-[#09090b]/95 backdrop-blur-md border-b border-white/5 py-4 shadow-xl';
          ...
          <div className="flex items-center shrink-0 mr-12 relative z-50">
            <Link href="/" className="block group">
              <div className="flex flex-col leading-none">
                <span className="font-serif font-black text-xl md:text-2xl tracking-tighter text-white group-hover:text-[#D4AF37] transition-colors duration-300">
                  SMIRNOV
                </span>
                <span className="font-sans font-bold text-[0.6rem] tracking-[0.3em] text-[#D4AF37] ml-0.5 group-hover:text-white transition-colors duration-300">
                  MARKETING
                </span>
              </div>
            </Link>
