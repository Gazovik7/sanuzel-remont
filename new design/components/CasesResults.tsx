  ...
  return (
    <section id="cases" className="py-16 md:py-24 bg-white relative overflow-hidden">
      ...
      <div className="mb-20 md:mb-32 relative z-20">
         ...
         <div className="relative w-full border-y border-gray-100 bg-white/50 backdrop-blur-sm py-8">
            {/* Gradient Masks */}
      ...
      {/* --- BACKGROUND TEXT --- */}
      <div className="absolute top-[380px] md:top-[320px] left-0 w-full overflow-hidden pointer-events-none z-0">
          <div className="text-[18vw] md:text-[16vw] font-serif font-black text-[#09090b]/[0.03] leading-none whitespace-nowrap text-center select-none">
              MARKETING
          </div>
      </div>
      ...
      <div className="container mx-auto px-6 md:px-12 max-w-[1400px] relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
           {CASES_DATA.slice(0, 8).map((item, idx) => (
              <motion.div 
                key={idx}
