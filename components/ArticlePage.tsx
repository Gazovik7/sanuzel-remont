...
import { Calendar, Clock, UserCheck, Shield, AlertCircle, Share2, Printer, ArrowRight, CheckCircle2, ShieldCheck, Calculator, MessageSquare } from 'lucide-react';
...
export const ArticlePage: React.FC<ArticlePageProps> = ({ id, onNavigate, onCalculate }) => {
  ...
  const processedContent = useMemo(() => {
    ...
    const ctaBlock = `
      ...
      <div class="not-prose my-10 relative overflow-hidden rounded-3xl bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100 p-8 shadow-lg group cursor-pointer js-article-calculator-btn">
          ...
          <div class="relative z-10 flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
              ...
              <button class="bg-blue-600 text-white font-bold py-3 px-6 rounded-xl shadow-lg shadow-blue-600/30 hover:bg-blue-700 transition-all transform group-hover:-translate-y-1">
                  Рассчитать смету
              </button>
          </div>
      </div>
  ...
  const articleSchema = {
    ...
    "publisher": {
        ...
        "logo": {
            "@type": "ImageObject",
            "url": "https://remont-sanuzlov.ru/logo.png"
        }
    }
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 max-w-6xl mx-auto">
            ...
            <div className="lg:col-span-8" id="article-content-container">
                ...
                <div className="mt-8 flex gap-4 font-sans">
                    <button className="flex items-center gap-2 px-6 py-3 rounded-xl bg-gray-50 text-slate-700 hover:bg-blue-50 hover:text-blue-600 transition-colors font-bold text-sm border border-gray-100">
                        <Share2 className="w-4 h-4" /> Поделиться
                    </button>
                    <button className="flex items-center gap-2 px-6 py-3 rounded-xl bg-gray-50 text-slate-700 hover:bg-gray-100 transition-colors font-bold text-sm border border-gray-100">
                ...
                <div className="sticky top-24 space-y-6">
                    ...
                    <div className="bg-slate-900 border border-slate-800 p-8 rounded-[2rem] shadow-2xl relative overflow-hidden text-white group">
                        ...
                        <div className="relative z-10 flex flex-col items-center text-center">
                             ...
                             <button onClick={onCalculate} className="w-full py-4 rounded-xl bg-blue-600 text-white font-bold hover:bg-blue-500 transition-all flex items-center justify-center gap-2 shadow-lg shadow-blue-600/40 transform hover:-translate-y-1">
                    ...
                    <div className="bg-white border border-gray-100 p-6 rounded-3xl shadow-sm">
                        ...
                        <button onClick={onCalculate} className="w-full py-3 border-2 border-slate-100 text-slate-700 rounded-xl font-bold text-sm hover:border-slate-900 hover:text-slate-900 transition-colors">
                            Открыть калькулятор
                        </button>
                    </div>
