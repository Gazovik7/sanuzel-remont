            ...
            <div className="grid lg:grid-cols-12 gap-16 items-center">
                ...
                <div className="lg:col-span-7 space-y-10">
                    ...
                    <div className="bg-white/5 backdrop-blur-md border border-white/10 p-6 rounded-3xl relative">
                        <div className="mb-6 flex items-center gap-3 p-3 bg-[#D4AF37]/10 border border-[#D4AF37]/20 rounded-xl">
                            <div className="relative flex h-2 w-2">
                                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#D4AF37] opacity-75"></span>
                                <span className="relative inline-flex rounded-full h-2 w-2 bg-[#D4AF37]"></span>
                            </div>
                            <span className="text-[10px] font-bold uppercase tracking-wider text-white">
                                В {currentMonth} осталось всего <span className="text-[#D4AF37]">4 бесплатных</span> аудит-стратегии
                            </span>
                        </div>
