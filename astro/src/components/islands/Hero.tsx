...
import { CASES_DATA, TEAM_MEMBERS, HERO_BULLETS, HERO_TICKER } from '../landing/constants';
  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20 pb-40 bg-[#09090b] text-white overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none select-none z-0">
          <div className="absolute bottom-[20%] left-0 w-full flex justify-center items-end overflow-hidden opacity-[0.03]">
