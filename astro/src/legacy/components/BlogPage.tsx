  ...
  return (
    <div className="min-h-screen bg-slate-50 animate-in fade-in duration-500 pb-12">
      <div className="container mx-auto px-4 pt-6 max-w-6xl">
        <Breadcrumbs 
            items={[{ label: 'Блог', isActive: true }]} 
        />
        ...
        <div className="mt-20 p-8 bg-slate-900 rounded-[2rem] relative overflow-hidden text-white">
             ...
             <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                 <div>
                     ...
                     <button data-lead-open="callback" className="bg-blue-600 text-white px-8 py-3 rounded-xl font-bold hover:bg-blue-500 transition-colors shadow-lg shadow-blue-600/30">
