  ...
  return (
    <div className="min-h-screen bg-slate-50 animate-in fade-in duration-500 pb-12">
      ...
      <div className="container mx-auto px-4 pt-6 max-w-5xl">
        ...
        <div className="mb-8">
            <h1 className="text-3xl md:text-5xl font-bold font-heading text-slate-900 mb-6">Прайс-лист 2025-2026</h1>
        ...
        <div className="mt-12 p-8 bg-blue-600 rounded-3xl text-center text-white relative overflow-hidden">
            <div className="relative z-10">
                ...
                <a href={`tel:${COMPANY_PHONE_TEL}`} className="inline-block bg-white text-blue-600 font-bold py-3 px-8 rounded-xl hover:bg-gray-50 transition-all shadow-lg">
                    Позвонить менеджеру
                </a>
            </div>
