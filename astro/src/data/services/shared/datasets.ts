...
export const PORTFOLIO: PortfolioItem[] = [
  ...
  },
  {
    ...
    workList:
      'Укладка широкоформатного керамогранита, запил под 45 градусов, подсветка ниш, безободковый унитаз.',
    time: '24 дня',
    price: '240 000 ₽',
  },
];
...
export const BUDGET_PORTFOLIO: PortfolioItem[] = [
  {
    ...
    desc:
      'Быстрый ремонт в новостройке. Задача: сделать чисто, аккуратно и максимально бюджетно.',
  ...
  },
  {
    ...
    workList:
      'Выравнивание стен, замена труб на полипропилен, укладка плитки 30x30, установка унитаза.',
    time: '9 дней',
    price: '85 000 ₽',
  },
  {
