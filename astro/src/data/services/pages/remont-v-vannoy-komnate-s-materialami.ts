...
export const page: ServicePage = {
  slug: 'remont-v-vannoy-komnate-s-materialami',
  path: '/remont-v-vannoy-komnate-s-materialami/',
  canonicalPath: '/remont-v-vannoy-komnate-s-materialami/',
  seo: {
  ...
  blocks: buildBlocks([
    unique({
      ...
      variant: 'default',
      config: {
        leadSource: 'hero-remont-v-vannoy-komnate-s-materialami',
