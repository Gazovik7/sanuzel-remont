...
export const page: ServicePage = {
  ...
  seo: {
    ...
    description:
      'Демонтажные работы в санузле | Бесплатный выезд сантехника | Гарантия до 3 лет | Быстрый ремонт от 1 дня! Лучшие цены на ремонт санузлов в Москве ? +7(499)348-97-42',
  },
  blocks: buildBlocks([
    unique({
      type: 'hero',
    ...
    unique({ type: 'breadcrumb', items: [{ label: 'Демонтажные работы', isActive: true }] }),
    use('comparison'),
